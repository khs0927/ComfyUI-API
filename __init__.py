...
ComfyUI imports this file as a package. Test runners may also inspect the repository
root as a top-level ``__init__`` module, where relative imports are invalid. In that
standalone case we expose empty mappings and leave the video controller modules
independently importable.
"""

if __package__:
    from .modules.fal_api_flux_controlnet_config_node import FalAPIFluxControlNetConfigNode
    from .modules.fal_api_flux_controlnet_union_config_node import (
        FalAPIFluxControlNetUnionConfigNode,
    )
    from .modules.fal_api_flux_dev_canny_with_lora_node import (
        FalAPIFluxDevCannyWithLoraNode,
    )
    from .modules.fal_api_flux_dev_image_to_image_node import (
        FalAPIFluxDevImageToImageNode,
    )
    from .modules.fal_api_flux_dev_node import FalAPIFluxDevNode
    from .modules.fal_api_flux_dev_with_lora_and_controlnet_image_to_image_node import (
        FalAPIFluxDevWithLoraAndControlNetImageToImageNode,
    )
    from .modules.fal_api_flux_dev_with_lora_and_controlnet_inpaint_node import (
        FalAPIFluxDevWithLoraAndControlNetInpaintNode,
    )
    from .modules.fal_api_flux_dev_with_lora_and_controlnet_node import (
        FalAPIFluxDevWithLoraAndControlNetNode,
    )
    from .modules.fal_api_flux_dev_with_lora_image_to_image_node import (
        FalAPIFluxDevWithLoraImageToImageNode,
    )
    from .modules.fal_api_flux_dev_with_lora_inpaint_node import (
